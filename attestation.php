        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="sec-title">
                    ...
                    <h2>Outstanding Attestation <span class="color3">Services.</span></h2>
            ...
            <div class="service-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    <div class="image-box">
                        ...
                        <h6 class="title">Student Attestation</h6>
                    </div>
                    <div class="content-box">
                        <h6 class="title"><a href="javascript:;">Student Attestation</a></h6>
            ...
            <div class="service-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="200ms">
                <div class="inner-box">
                    <div class="image-box">
                        ...
                        <h6 class="title">Business Attestation</h6>
                    </div>
                    <div class="content-box">
                        <h6 class="title"><a href="javascript:;">Business Attestation</a></h6>
                        <div class="text">We have to a tendency to believe the idea that smart looking of any website.</div>
                        <a href="javascript:;" class="read-more">More <i class="fa fa-long-arrow-right"></i></a>
                    </div>
                </div>
            ...
            <div class="service-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    <div class="image-box">
                        ...
                        <h6 class="title">Family Attestation</h6>
                    </div>
                    <div class="content-box">
                        <h6 class="title"><a href="javascript:;">Family Attestation</a></h6>
                        <div class="text">We have to a tendency to believe the idea that smart looking of any website.</div>
                        <a href="javascript:;" class="read-more">More <i class="fa fa-long-arrow-right"></i></a>
                    </div>
                </div>
            ...
            <div class="service-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="200ms">
                <div class="inner-box">
                    <div class="image-box">
                        ...
                        <h6 class="title">Tourist Attestation</h6>
                    </div>
                    <div class="content-box">
                        <h6 class="title"><a href="javascript:;">Tourist Attestation</a></h6>
                        <div class="text">We have to a tendency to believe the idea that smart looking of any website.</div>
                        <a href="javascript:;" class="read-more">More <i class="fa fa-long-arrow-right"></i></a>
                    </div>
                </div>
            ...
            <div class="service-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                <div class="inner-box">
                    <div class="image-box">
                        ...
                        <h6 class="title">Residence Attestation</h6>
                    </div>
                    <div class="content-box">
                        <h6 class="title"><a href="javascript:;">Residence Attestation</a></h6>
                        <div class="text">We have to a tendency to believe the idea that smart looking of any website.</div>
                        <a href="javascript:;" class="read-more">More <i class="fa fa-long-arrow-right"></i></a>
                    </div>
                </div>
            ...
            <div class="cta-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="600ms">
                <div class="inner-box">
                    <h4 class="title"><a href="javascript:;">Get Attestation with 100% success rate</a></h4>
...
<section class="process-section">
    ...
    <div class="auto-container">
        <div class="sec-title text-center">
            ...
            <h2>Get your Attestation approved in <br>3 easy simple <span class="color3">steps</span></h2>
        </div>
        <div class="row">
            ...
            <div class="process-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                <div class="inner-box">
                    ...
                    <div class="info-box">
                        <div class="inner">
                            <h6 class="title">Receive Your Attestation</h6>
                            <div class="text">Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.</div>
                        </div>
                    </div>
                </div>
...
<section class="features-section ansh-fet">
    <div class="auto-container">
        <div class="sec-title text-center">
            <h2>Process For Student <span class="color3">Attestations</span></h2>
        </div>
        <div class="row">
            ...
            <div class="feature-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    ...
                    <a href="#" class="theme-btn btn-style-one step">Apply for New Attestation</a>
                    <div class="overlay-content">
                        <div class="title-box">
                            <i class="icon flaticon-immigration-1"></i>
                            <h6 class="title">Apply for New Attestation</h6>
                        </div>
            ...
            <div class="feature-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
                <div class="inner-box">
                    ...
                    <a href="#" class="theme-btn btn-style-one step">Attestation Program</a>
                    <div class="overlay-content">
                        <div class="title-box">
                            <i class="icon flaticon-immigration-1"></i>
                            <h6 class="title">Attestation Program</h6>
                        </div>
                        <div class="text">Neque porro quisqum est qui dolorem ipsum quia dolor. tellus est aliquet egetristique nisullam.</div>
                        <a href="page-service.html" class="theme-btn btn-style-three read-more">Read More</a>
                    </div>
